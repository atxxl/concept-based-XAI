...
parser.add_argument('--LAMBD_XtoC', type=float, default=5.,
                    help='Rate for the final target sparsity.')
parser.add_argument('--model_path', default='/zhome/81/3/170259/SparseCBM/run_cebab/s4e_model/',
...
data_type = "goemo_500" # "pure_cebab"/"aug_cebab"/"aug_yelp"/"aug_cebab_yelp"
# Load data
if data_type == "goemo_500":
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for concept in self.concepts:
            # tensor_dict[f"{concept}_concept"] = torch.tensor(f"{concept}_concept", dtype=torch.long)
